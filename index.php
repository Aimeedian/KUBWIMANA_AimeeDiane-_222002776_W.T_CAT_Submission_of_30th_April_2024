...
<body style="background-image: url('./emplo.jpeg');
background-repeat: no-repeat;background-size: cover;">

<div class="overlay">
  <div class="container">
    <h1 style="color: deeppink;">WELCOME TO ONLINE EMPLOYEE ATTENDANCE</h1>
    <p><i><b>All employee can be deserved well</b></i></p>
