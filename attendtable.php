...
<div style="margin-left: 500px;"><form action="search.php" method="GET">
    ...
    <center><h2><i> TABLE FOR ATTENDANCE </h2></i></center>
    <table>
        <tr>
            <th>Attendance Id</th>
            <th>Employee_Code</th>
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr>
                    ...
                    <td style='background-color:#007bff'><a style='padding:4px' href='update_attendance.php?id=$pid'>Update</a></td> 
                </tr>";
            }
        } else {
 ...
 <div><footer style="background-color:teal;text-align: center;width:100%;height:70px; color: white;font-size: 25px;bottom:0px;"><p style="margin-top: 20px;"> Designed by Aimee Diane KUBWIMANA_222002776 &copy YEAR TWO BIT GROUP A &reg 2024</p></footer></div>
